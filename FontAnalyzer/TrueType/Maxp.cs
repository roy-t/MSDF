...
namespace FontAnalyzer.TrueType
{
    public class Maxp : KaitaiStruct
    {
        ...
        /// </summary>
        public Fixed TableVersionNumber { get { return this._tableVersionNumber; } }

        /// <summary>
        /// The number of glyphs in the font.
        /// </summary>
        public ushort NumGlyphs { get { return this._numGlyphs; } }

        /// <summary>
        /// Maximum points in a non-composite glyph.
        /// </summary>
        public ushort MaxPoints { get { return this._maxPoints; } }

        /// <summary>
        /// Maximum contours in a non-composite glyph.
        /// </summary>
        public ushort MaxContours { get { return this._maxContours; } }

        /// <summary>
        /// Maximum points in a composite glyph.
        /// </summary>
        public ushort MaxCompositePoints { get { return this._maxCompositePoints; } }

        /// <summary>
        /// Maximum contours in a composite glyph.
        /// </summary>
        public ushort MaxCompositeContours { get { return this._maxCompositeContours; } }

        /// <summary>
        /// 1 if instructions do not use the twilight zone (Z0), or 2 if instructions do use Z0; should be set to 2 in most cases.
        /// </summary>
        public ushort MaxZones { get { return this._maxZones; } }

        /// <summary>
        /// Maximum points used in Z0.
        /// </summary>
        public ushort MaxTwilightPoints { get { return this._maxTwilightPoints; } }

        /// <summary>
        /// Number of Storage Area locations.
        /// </summary>
        public ushort MaxStorage { get { return this._maxStorage; } }

        /// <summary>
        /// Number of FDEFs.
        /// </summary>
        public ushort MaxFunctionDefs { get { return this._maxFunctionDefs; } }

        /// <summary>
        /// Number of IDEFs.
        /// </summary>
        public ushort MaxInstructionDefs { get { return this._maxInstructionDefs; } }

        /// <summary>
        /// Maximum stack depth.
        /// </summary>
        public ushort MaxStackElements { get { return this._maxStackElements; } }

        /// <summary>
        /// Maximum byte count for glyph instructions.
        /// </summary>
        public ushort MaxSizeOfInstructions { get { return this._maxSizeOfInstructions; } }

        /// <summary>
        /// Maximum number of components referenced at &quot;top level&quot; for any composite glyph.
        /// </summary>
        public ushort MaxComponentElements { get { return this._maxComponentElements; } }

        /// <summary>
        /// Maximum levels of recursion; 1 for simple components.
        /// </summary>
        public ushort MaxComponentDepth { get { return this._maxComponentDepth; } }
